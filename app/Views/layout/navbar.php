<?php
$notification = get_data($select = '*', $table_name = 'tb_log', $where = ['hash_user' => session()->get('hash_user'), 'deleted_at' => 0], $limit = 6)->getResultArray();
?>
<!-- ============================================================== -->
                    ...
                    <a class="navbar-brand" href="#">
                        ...
                        <b>
                            ...
                            <?php if (!empty(identity()['identity_logo_icon'])) { ?>
                                <!-- Dark Logo icon -->
                                <img src="<?= base_url(); ?>/<?= identity()['identity_logo_icon'] ?>" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="<?= base_url(); ?>/<?= identity()['identity_logo_icon'] ?>" alt="homepage" class="light-logo" />
                            <?php } ?>
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
                            <?php if (!empty(identity()['identity_logo_text'])) { ?>
                                <!-- dark Logo text -->
                                <img src="<?= base_url(); ?>/<?= identity()['identity_logo_text'] ?>" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->    
                                <img src="<?= base_url(); ?>/<?= identity()['identity_logo_text'] ?>" class="light-logo" alt="homepage" />
                            <?php } ?>
                        </span> 
                    </a>
                </div>
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-history"></i>
                                <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
                                <ul>
                                    <li>
                                        <div class="drop-title">Activity</div>
                                    </li>
                                    <li>
                                                ...
                                                <?php foreach ($notification as $key => $value) { ?>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <div class="mail-contnet">
                                                            <span class="mail-desc"><?= $value['description']; ?></span>
                                    ...
                                    <li>
                                        <a class="nav-link text-center link" href="<?= base_url(); ?>/log"> <strong>Check all Activity</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?= base_url(); ?>/<?= session()->get('foto') ?>" alt="user" class=""> <span class="hidden-md-down"><?= session()->get('nama_lengkap'); ?> &nbsp;<i class="fa fa-angle-down"></i></span> </a>
